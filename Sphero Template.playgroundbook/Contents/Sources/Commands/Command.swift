...
public protocol CoreCommand: Command {
    static func response(responseId:UInt8, sequenceNumber: UInt8) -> Data
}
...
public struct VersioningCommand: CoreCommand {
...
public struct GoToSleepCommand: CoreCommand {
...
public struct PowerStateCommand: CoreCommand {
...
public struct SetMainLEDColor: SpheroCommand {
...
public struct SetStabilization: SpheroCommand {
...
public struct ConfigureCollisionDetection: SpheroCommand {
    ...
    public struct Configuration {
        ...
        public let xThreshold: UInt8
        public let xSpeedThreshold: UInt8
        public let yThreshold: UInt8
        public let ySpeedThreshold: UInt8
        public let postTimeDeadZone: TimeInterval
        ...
        public static var enabled: Configuration {
            get {
        ...
        public static var disabled: Configuration {
            get {
                return Configuration(
                    detectionMethod: .off,
                    xThreshold: 0.0,
...
public struct Roll: SpheroCommand {
    ...
    public init(heading: UInt16, speed: UInt8, state: RollType = .roll) {
        self.heading = heading
        self.speed = speed
        self.state = state
    }
    ...
    public var payload: Data? {
        ...
        return Data(bytes: [speed, headingLeft, headingRight, state.rawValue])
    }
}
...
public struct EnableSensors: SpheroCommand {
    public let commandID: UInt8 = SpheroCommandId.setDataStreaming.rawValue
    
    public let streamingRate: Int
    public let streamingSensors: SensorMask
    
    private var nativeStreamingRate = 400
    private var packetFrames:UInt16 = 1
    
    public init(sensorMask: SensorMask, streamingRate: Int) {
        self.streamingSensors = sensorMask
        self.streamingRate = streamingRate
        
        DataStreamingDataTracker.frameCount = Int(packetFrames)
        DataStreamingDataTracker.sensorMask = sensorMask
    }
...
public struct ConfigureLocatorCommand: SpheroCommand {
...
public struct SetOptionsFlagsCommand: SpheroCommand {
