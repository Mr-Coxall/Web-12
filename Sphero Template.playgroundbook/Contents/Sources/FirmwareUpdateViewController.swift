...
public class FirmwareUpdateViewController: ModalViewController {
    ...
    public var connectedToy: SpheroV1Toy? {
        didSet {
            updateViews()
        }
    }
    ...
    public override func viewDidLoad() {
        ...
        let topSafeConstraint = safeContainer.topAnchor.constraint(equalTo: topLayoutGuide.topAnchor, constant: safeAreaLayoutGuide?.layoutFrame.minY ?? 0.0)
        let bottomSafeConstraint = safeContainer.bottomAnchor.constraint(equalTo: bottomLayoutGuide.bottomAnchor, constant: -(view.bounds.size.height - (safeAreaLayoutGuide?.layoutFrame.maxY ?? 0.0)))
    ...
    public override func updateViewConstraints() {
        ...
        if let safeAreaFrame = safeAreaLayoutGuide?.layoutFrame {
    ...
    static public func instantiate(with toy: SpheroV1Toy?) -> FirmwareUpdateViewController {
